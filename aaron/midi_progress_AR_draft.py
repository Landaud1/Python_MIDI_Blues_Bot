...
""""PERFORMING OUR MAIN FUNCTION (OUTSIDE A FUNCTION FOR CHECKING VARIABLES)"""
...
# Copy tempo if exist
# We iterate through each track (kind of through each instrument)
# If the track doesn't contain any notes, we simply pass it
